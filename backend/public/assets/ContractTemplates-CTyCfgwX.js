import{K as me,N as _e,c as w,b as t,w as a,G as m,r as d,i as h,h as E,O as fe,o as c,a as v,g as i,Q as ye,k as D,q as p,F as S,n as $,l as G,P as K,m as Q,I as be}from"./index-CwIWMC62.js";import{g as ge,a as H,d as ve,u as ke,b as Ve}from"./contractTemplate-DI6xkYN9.js";import{_ as Ce}from"./_plugin-vue_export-helper-DlAUqK2U.js";const we={class:"contract-templates-container"},he={class:"card-header"},xe={class:"search-section"},Ue={class:"pagination-section"},ze={class:"template-editor"},Te={class:"editor-toolbar"},De={key:0,style:{"margin-top":"10px"}},Se={class:"template-preview"},$e={__name:"ContractTemplates",setup(Be){const B=h(!1),y=h(!1),T=h(!1),U=h(!1),N=h(null),F=[{key:"contract_number",label:"合同编号",default:""},{key:"customer_name",label:"客户名称",default:""},{key:"customer_phone",label:"客户电话",default:""},{key:"machine_type",label:"机械类型",default:""},{key:"service_content",label:"服务内容",default:""},{key:"annual_fee",label:"合同金额",default:"0"},{key:"start_date",label:"开始日期",default:""},{key:"end_date",label:"结束日期",default:""},{key:"sign_date",label:"签订日期",default:""},{key:"company_name",label:"公司名称",default:""},{key:"company_address",label:"公司地址",default:""},{key:"company_phone",label:"公司电话",default:""}],u=E({name:"",type:""}),_=E({page:1,pageSize:10,total:0}),o=E({id:null,name:"",type:"repair_contract",description:"",content:"",custom_variables:[]}),J={name:[{required:!0,message:"请输入模板名称",trigger:"blur"}],type:[{required:!0,message:"请选择模板类型",trigger:"change"}],content:[{required:!0,message:"请输入模板内容",trigger:"blur"}]},k=h(null),R=h([]),M=r=>({repair_contract:"维修合同",service_agreement:"服务协议",confidentiality:"保密协议",trade_contract:"交易合同"})[r]||r,V=async()=>{B.value=!0;try{const r={};u.name&&(r.name=u.name),u.type&&(r.type=u.type);const e=await ge(_.page,_.pageSize,r);if(e.code===200||e.code===0||e.code===201){const s=e.data||{};R.value=s.items||s.list||[],_.total=s.total||0}}catch(r){console.error("获取合同模板列表失败",r),m.error("获取数据失败")}finally{B.value=!1}},j=()=>{_.page=1,V()},W=()=>{u.name="",u.type="",j()},X=()=>{o.id=null,o.name="",o.type="repair_contract",o.description="",o.content=I(o.type),o.custom_variables=[]},I=(r="repair_contract")=>r==="trade_contract"?`产品买卖合同
