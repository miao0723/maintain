...
class AIService
{
    ...
    private function buildExpensePrompt($data)
    {
        ...
        $prompt .= "=== 报告要求 ===\n";
        $prompt .= "请生成一份简洁美观的支出分析报告，要求：\n";
        $prompt .= "1. 使用简洁语言，每段控制在3-5行\n";
        $prompt .= "2. 突出关键数据和支出占比，避免冗长描述\n";
        $prompt .= "3. 使用要点列出3-5条最核心的成本控制建议\n";
        $prompt .= "4. 格式清晰：用##表示章节，用-表示要点\n";
        $prompt .= "5. 总篇幅控制在800字以内，突出可执行性\n";
        $prompt .= "6. 每个章节聚焦一个核心观点，避免信息过载\n\n";
    ...
    private function buildOrderPrompt($data)
    {
        ...
        $prompt .= "=== 报告要求 ===\n";
        $prompt .= "请生成一份简洁美观的订单分析报告，要求：\n";
        $prompt .= "1. 使用简洁语言，每段控制在3-5行\n";
        $prompt .= "2. 突出关键数据和完成率，避免冗长描述\n";
        $prompt .= "3. 使用要点列出3-5条最核心的运营建议\n";
        $prompt .= "4. 格式清晰：用##表示章节，用-表示要点\n";
        $prompt .= "5. 总篇幅控制在800字以内，突出可执行性\n";
        $prompt .= "6. 每个章节聚焦一个核心观点，避免信息过载\n\n";
