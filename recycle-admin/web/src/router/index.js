...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'qc-orders', name: 'QcOrders', component: () => import('../views/QcOrders.vue'), meta: { title: '质检单', icon: 'CircleCheck' } },
      { path: 'qc-templates', name: 'QcTemplates', component: () => import('../views/QcTemplates.vue'), meta: { title: '质检模板与标准', icon: 'SetUp' } },
